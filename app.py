            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    if "help" in message_text:
                        send_message(sender_id, "We are happy to help! Type 'rights', 'travel ban', or 'enforcement' for specific information.")
                    ...
                    elif "enforce" in message_text:
                        send_message(sender_id, "Visit https://www.miracoalition.org/enforcement for more information.")
                    else:
